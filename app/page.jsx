   ...
   <div className="pt-20 flex flex-col">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">Find your Dream Car with SmartWheelz</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                 Thousands of verified vehicles from trusted 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                 Book a test drive online in minutes, 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Verfied Listing and secure booking 
                process for peace of mind </p>
            </div>
          </div>
        </div>
      </section>
